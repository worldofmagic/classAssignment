...
class StorageAgent 
{
	// FABRICATION --- new class not existing in domain model is "fabricated" to store and retrieve serialized objects
	private static final String filename ="Objects.ser";
